      ...
      {tree.map((item) => (
        <li key={item.id} className="node">
          <div className="node-content">
            ...
            <div
              className={currentItem === item ? 'value-selected' : 'value'}
  ...
  return (
    <div className="page">
      ...
      <div className="tree-container">
        ...
        {showNodePopup && <NodePopup treeId={treeId} modal={showNodePopup} nodeId={nodeId} parentNodeId={parentNodeId} handleTreeSelected={handleTreeSelected}/>}
      </div>
    </div>
  );
}
